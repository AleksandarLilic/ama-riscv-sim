...
class uart : public dev {
    private:
        ...
        #ifndef DPI
        #ifdef UART_INPUT_EN
        // RX input drained one byte per ~char-time
        // uses same virtual clock as mtime (10ns/inst @ 100MHz, 1 IPC):
        // inst/char = (10 bits / baud) / 10ns = 1e9 / baud
        // 8N1 => 10 bits/char
    ...
    public:
        ...
        void update_input(uint64_t time);
        #endif
        #endif
};
