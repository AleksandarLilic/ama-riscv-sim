...
uint32_t core::alu_sra(uint32_t a, uint32_t b) {
    b &= 0x1f;
    return TO_I32(a) >> b;
};
uint32_t core::alu_slt(uint32_t a, uint32_t b) {
...
// immediates
uint32_t core::alu_addi(uint32_t a, uint32_t b) {
    return alu_add(a, b);
};
...
uint32_t core::alu_srli(uint32_t a, uint32_t b) {
    return alu_srl(a, b);
};
uint32_t core::alu_srai(uint32_t a, uint32_t b) {
    return alu_sra(a, b);
};
...
uint32_t core::alu_sltiu(uint32_t a, uint32_t b) {
    return alu_sltu(a, b);
};
uint32_t core::alu_xori(uint32_t a, uint32_t b) {
    return alu_xor(a, b);
};
uint32_t core::alu_ori(uint32_t a, uint32_t b) {
    return alu_or(a, b);
};
uint32_t core::alu_andi(uint32_t a, uint32_t b) {
    return alu_and(a, b);
};
