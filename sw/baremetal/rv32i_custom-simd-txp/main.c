...
void main() {
    for (uint32_t i = 0; i < LOOPS; i++) {
        ...
        { // txp16: rd = [rs1.H[0], rs2.H[0]], rdp = [rs1.H[1], rs2.H[1]]
            {
        ...
        { // txp8: rd = [rs1.B[0], rs2.B[0], rs1.B[2], rs2.B[2]]
            {
        ...
        { // txp4: even nibbles -> rd, odd -> rdp
            {
                GLOBAL_SYMBOL("op_txp4");
        ...
        { // txp2: even 2-bit lanes -> rd, odd -> rdp
            {
                GLOBAL_SYMBOL("op_txp2");
