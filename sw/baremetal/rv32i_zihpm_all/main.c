...
void main() {
    ...
    TEST_CSR(CSR_MHPMEVENT6, mhpmevent_stall_load);
    TEST_CSR(CSR_MHPMEVENT7, mhpmevent_ret_ctrl_flow);
    TEST_CSR(CSR_MHPMEVENT8, mhpmevent_ret_ctrl_flow_j);
    TEST_CSR(CSR_MHPMEVENT3, mhpmevent_ret_ctrl_flow_jr);
    TEST_CSR(CSR_MHPMEVENT4, mhpmevent_ret_ctrl_flow_br);
    TEST_CSR(CSR_MHPMEVENT5, mhpmevent_ret_mem);
    TEST_CSR(CSR_MHPMEVENT6, mhpmevent_ret_mem_load);
    TEST_CSR(CSR_MHPMEVENT7, mhpmevent_ret_mem_store);
    TEST_CSR(CSR_MHPMEVENT8, mhpmevent_ret_simd);
    TEST_CSR(CSR_MHPMEVENT3, mhpmevent_ret_simd_arith);
    TEST_CSR(CSR_MHPMEVENT4, mhpmevent_ret_simd_data_fmt);
