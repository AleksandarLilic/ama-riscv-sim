...
void main() {
    for (uint32_t i = 0; i < LOOPS; i++) {
        ...
        { // uint16
            uint16_t in[] = {1, 16153};
            uint32x2_t result = _widen16u(v_load_uint16x2(in), 0);
        ...
        { // int8
            ...
            int16x4_t result = _widen8(v_load_int8x4(in), 0);
            int32x2_t result_32;
            result_32 = _widen16(result.w.lo, 0);
            CHECK(result_32.w.lo, in[0], 201);
            CHECK(result_32.w.hi, in[1], 202);
            result_32 = _widen16(result.w.hi, 0);
        ...
        { // uint8
            ...
            uint16x4_t result = _widen8u(v_load_uint8x4(in), 0);
            uint32x2_t result_32;
            result_32 = _widen16u(result.w.lo, 0);
            CHECK(result_32.w.lo, in[0], 211);
            CHECK(result_32.w.hi, in[1], 212);
            result_32 = _widen16u(result.w.hi, 0);
        ...
        { // int4
            ...
            int8x8_t result = _widen4(v_load_int4x8(in), 0);
            int16x4_t result_16;
            int32x2_t result_32;

            result_16 = _widen8(result.w.lo, 0);
            result_32 = _widen16(result_16.w.lo, 0);
            CHECK(result_32.w.lo, 7, 301);
            CHECK(result_32.w.hi, 0, 302);
            result_32 = _widen16(result_16.w.hi, 0);
            CHECK(result_32.w.lo, 2, 303);
            CHECK(result_32.w.hi, 0, 304);

            result_16 = _widen8(result.w.hi, 0);
            result_32 = _widen16(result_16.w.lo, 0);
        ...
        { // uint4
            ...
            uint8x8_t result = _widen4u(v_load_uint4x8(in), 0);
            uint16x4_t result_16;
            uint32x2_t result_32;

            result_16 = _widen8u(result.w.lo, 0);
            result_32 = _widen16u(result_16.w.lo, 0);
            CHECK(result_32.w.lo, 4, 311);
            CHECK(result_32.w.hi, 7, 312);
            result_32 = _widen16u(result_16.w.hi, 0);
            CHECK(result_32.w.lo, 1, 313);
            CHECK(result_32.w.hi, 0, 314);

            result_16 = _widen8u(result.w.hi, 0);
            result_32 = _widen16u(result_16.w.lo, 0);
        ...
        { // int2
            ...
            int4x16_t result = _widen2(v_load_int2x16(in), 0);
            int8x8_t result_8;
            int16x4_t result_16;
            int32x2_t result_32;

            result_8 = _widen4(result.w.lo, 0);
            result_16 = _widen8(result_8.w.lo, 0);
            result_32 = _widen16(result_16.w.lo, 0);
            ...
            result_16 = _widen8(result_8.w.hi, 0);
            result_32 = _widen16(result_16.w.lo, 0);
            ...
            result_8 = _widen4(result.w.hi, 0);
            result_16 = _widen8(result_8.w.lo, 0);
            result_32 = _widen16(result_16.w.lo, 0);
        ...
        { // uint2
            ...
            uint4x16_t result = _widen2u(v_load_uint2x16(in), 0);
            uint8x8_t result_8;
            uint16x4_t result_16;
            uint32x2_t result_32;

            result_8 = _widen4u(result.w.lo, 0);
            result_16 = _widen8u(result_8.w.lo, 0);
            result_32 = _widen16u(result_16.w.lo, 0);
            ...
            result_16 = _widen8u(result_8.w.hi, 0);
            result_32 = _widen16u(result_16.w.lo, 0);
            ...
            result_8 = _widen4u(result.w.hi, 0);
            result_16 = _widen8u(result_8.w.lo, 0);
            result_32 = _widen16u(result_16.w.lo, 0);
