...
// interrupt codes
#define MCAUSE_INTERRUPT_BIT (uint32_t)(1u << 31)
#define MCAUSE_MACHINE_SW_INT (MCAUSE_INTERRUPT_BIT | 0x3u)
#define MCAUSE_MACHINE_TIMER_INT (MCAUSE_INTERRUPT_BIT | 0x7u)
#define MCAUSE_MACHINE_EXT_INT (MCAUSE_INTERRUPT_BIT | 0xBu) // 11
#define MCAUSE_MACHINE_LCOF_INT (MCAUSE_INTERRUPT_BIT | 0xDu) // 13
